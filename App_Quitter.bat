...
echo.
echo Step-3 : Right click the Application and Choose "Open file location"
echo.
...
echo.
echo Step-6 : There you will a Target field. 
echo.
...
echo.
echo          "mspaint" will be the Application name for the Paint
echo.
echo.
